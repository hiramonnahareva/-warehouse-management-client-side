...
const Item = ({item}) => {
    const {img, name, descrption, _id, price, quentity, supplier} = item;
    return (
        <div className='shadow-lg p-3' >
           ...
           <p className='text-gray-700 text-[17px] font-semibold lg:leading-20 pb-2 text-justify'>id: <span className='text-amber-500'>{_id}</span></p>
           <p className='text-gray-700 font-semibold lg:leading-20 pb-2 text-justify'>Price: <span className='text-amber-500'>{price}</span></p>
           <p className='text-[17px] text-gray-700 font-semibold lg:leading-20 pb-2 text-justify'>quentity: <span className='text-amber-500'>{quentity}</span></p>
